...
env.workspace = "C:\Users\Sara\Desktop\chinalights_data\ChinaLightsCc.gdb"

# Check out any necessary licenses
arcpy.CheckOutExtension("spatial")

# Input files (all in "H:/Research/Data/Lights/china.gdb")
# TODO: redefine the inputs
...
# Variables
# china shapefile minus the gas flares
ctryg = "china_minus_flares"
# roads of china
...
# Process: Clip
    arcpy.Clip_analysis("C:/Users/Sara/Desktop/chinalights_data/china1.shp", "C:/Users/Sara/Desktop/chinalights_data/roadbuff.shp", "china2.shp", "")
...
# Clip each lights raster to extent of china2
    ...
    for raster in rasterList:
        arcpy.Clip_management(raster, "-179.9999999999 -90.0000000187858 180.0000000001 83.6274185353372",
                              "G"+str(raster[1:]), "C:/Users/Sara/Desktop/chinalights_data/china2.shp", "", "ClippingGeometry")
        print raster + " clipped"

    arcpy.Delete_management("C:/Users/Sara/Desktop/chinalights_data/china1.shp")
    arcpy.Delete_management("C:/Users/Sara/Desktop/chinalights_data/china2.shp")
    arcpy.Delete_management("C:/Users/Sara/Desktop/chinalights_data/roadbuff.shp")
...
# Process: Clip grid to perimeter of polygon
    arcpy.Clip_analysis("C:/Users/Sara/Desktop/chinalights_data/ch_grid.shp", "C:/Users/Sara/Desktop/chinalights_data/G101992p.shp", "china_grid.shp", "")

# Zonal statistics on each year (plus delete intermediate files)
    rasterList = arcpy.ListRasters("G*")
    for raster in rasterList:
        arcpy.gp.ZonalStatisticsAsTable_sa("C:/Users/Sara/Desktop/chinalights_data/china_grid.shp", "FID", raster, "l"+str(raster[5:])+".dbf", "DATA", "MEAN")
        arcpy.Delete_management(raster)
        print "Got zonal stats for " + str(raster[5:])

    arcpy.Delete_management("C:/Users/Sara/Desktop/chinalights_data/ch_grid.shp")
    arcpy.Delete_management("C:/Users/Sara/Desktop/chinalights_data/G101992p.shp")

    print "Calculating nearest roads." 
# Process: Near
    arcpy.Near_analysis("C:/Users/Sara/Desktop/chinalights_data/china_grid.shp", road, "", "LOCATION", "NO_ANGLE")
